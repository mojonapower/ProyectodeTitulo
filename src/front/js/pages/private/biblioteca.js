      ...
      <>
        <div className="container-fluid" style={{
          ...
          <div className="row d-flex justify-content-end my-5 mx-5">
            <p className=" col-6  my-5">Bienvenido a nuestro centro de documentación! Es un espacio dedicado a toda nuestra comunidad educativa. Acá compartimos documentación de interés tales como Planificaciones, protocolos, materiales educativos, cuentos y mucho más. Todo lo que nuestras Educadoras y cuerpo técnico necesita disponibilizar y utilizar</p>
            <div className="row">
